...
output_dir="${PHASE1_CUB_OUTPUT_DIR:-/app/output/phase1_cub_b128_full_v1_shard_b}"
cache_dir="${PHASE1_CUB_CACHE_DIR:-/app/scratch/phase1_cub_b128_full_v1_shard_b_cache}"
