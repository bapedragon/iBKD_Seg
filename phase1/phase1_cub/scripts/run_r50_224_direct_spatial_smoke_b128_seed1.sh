...
output_root="${PHASE1_CUB_DIRECT_SPATIAL_SMOKE_OUTPUT_DIR:-/app/output/phase1_cub_r50_224_b128_seed1_direct_spatial_smoke_v1}"
...
smoke_config="phase1/phase1_cub/configs/cub200_r50_224_b128_direct_spatial_smoke_v1.json"
