...
output_root="${PHASE1_CUB_DIRECT_SPATIAL_SEED23_FULL_OUTPUT_DIR:-/app/output/phase1_cub_r50_224_b128_seed2_3_direct_spatial_full_v2}"
...
full_config="phase1/phase1_cub/configs/cub200_r50_224_b128_seed2_3_direct_spatial_full_v2.json"
