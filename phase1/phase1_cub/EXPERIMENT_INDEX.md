...
| `main_l0_mechanism_v1` | `main_l0_v3`에서 iBKD 레이어 연결 원인을 분리하는 사후 실험 | 기존 checkpoint 관찰 감사 완료, 인과 smoke 준비 | 새 결과는 별도 사후 원인 분석으로만 사용 | `mechanism_analysis/` |
