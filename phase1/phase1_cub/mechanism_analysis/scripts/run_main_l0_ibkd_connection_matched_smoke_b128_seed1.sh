...
output_root="${PHASE1_CUB_MATCHED_CONNECTION_SMOKE_OUTPUT_DIR:-/app/output/phase1_cub_main_l0_ibkd_connection_matched_smoke_v2}"
...
config="phase1/phase1_cub/mechanism_analysis/configs/cub200_r50_224_b128_main_l0_ibkd_connection_matched_smoke_v2.json"
...
run_suite() {
  ...
  python -m ibkd_seg.phase1.run_cub_ibkd_connection_matched_smoke \
    --smoke-run \
    --data-dir "${data_dir}" \
