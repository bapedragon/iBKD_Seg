...
output_root="${PHASE1_CUB_CONTROLLED_AA_SMOKE_OUTPUT_DIR:-/app/output/phase1_cub_main_l0_ibkd_controlled_aa_smoke_v2}"
...
protocol_config="phase1/phase1_cub/reproducibility/configs/cub200_r50_224_b128_main_l0_ibkd_controlled_aa_smoke_v2.json"
...
run_suite() {
  ...
  python -m ibkd_seg.phase1.run_cub_ibkd_controlled_aa_smoke \
    --smoke-run \
    --data-dir "${data_dir}" \
