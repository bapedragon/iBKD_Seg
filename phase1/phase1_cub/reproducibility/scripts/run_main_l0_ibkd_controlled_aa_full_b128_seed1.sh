...
output_root="${PHASE1_CUB_CONTROLLED_AA_FULL_OUTPUT_DIR:-/app/output/phase1_cub_main_l0_ibkd_controlled_aa_full_v1}"
...
protocol_config="phase1/phase1_cub/reproducibility/configs/cub200_r50_224_b128_main_l0_ibkd_controlled_aa_full_v1.json"
...
run_suite() {
  ...
  python -m ibkd_seg.phase1.run_cub_ibkd_controlled_aa_full \
    --full-run \
    --data-dir "${data_dir}" \
