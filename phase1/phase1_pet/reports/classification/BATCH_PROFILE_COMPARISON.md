...
```bash
python phase1/phase1_pet/scripts/compare_classification_profiles.py \
  --batch64-summary phase1/phase1_pet/reports/classification/batch64/summary.json \
  --batch128-summary phase1/phase1_pet/reports/classification/batch128/summary.json \
  --output-json phase1/phase1_pet/reports/classification/batch_profile_comparison.json \
  --output-csv phase1/phase1_pet/reports/classification/batch_profile_comparison.csv
```
