...
`phase1/phase1_pet/results/raw/` 아래에 보관하며 `.gitignore`로 제외합니다. 원본 ZIP은 CRC와
...
```bash
PYTHONPATH=src python phase1/phase1_pet/scripts/import_classification_archive.py \
  /path/to/result.zip \
  --batch-size 128 \
  --issue-id 702 \
  --output-dir phase1/phase1_pet/results/raw/oxford_iiit_pet/full_classification_v1/batch128 \
...
```bash
PYTHONPATH=src python phase1/phase1_pet/scripts/curate_classification_results.py \
  --raw-dir phase1/phase1_pet/results/raw/oxford_iiit_pet/full_classification_v1/batch128 \
  --report-dir phase1/phase1_pet/reports/classification/batch128
```
