...
4. **결과 확인 뒤 protocol을 바꾸면 안 됩니다.** probe head, LR grid, selection,
   ...
   ablation으로 분리해야 합니다.
5. **후속 결과까지 포함한 Phase 1 결정은 No-Go입니다.** Batch 128 probe에서도
   LG가 1위였고, canonical ALG 조기 종료를 피한 warm-up 20 사후 진단에서는 ALG가
   iBKD 두 λ보다 높았습니다. 최종 근거는 [Phase 1 결정문](../../../DECISION.md)에
   있습니다.
...
- Git 제외 raw:
  `phase1/phase1_pet/results/raw/oxford_iiit_pet/frozen_probe_v1/batch64/`
