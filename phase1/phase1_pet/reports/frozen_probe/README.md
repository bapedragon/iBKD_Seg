...
```bash
PYTHONPATH=src python phase1/phase1_pet/scripts/import_probe_archive.py \
  /path/to/result.zip \
  --batch-size 128 \
  --issue-id ISSUE_ID \
  --output-dir phase1/phase1_pet/results/raw/oxford_iiit_pet/frozen_probe_v1/batch128 \
...
```bash
PYTHONPATH=src python phase1/phase1_pet/scripts/curate_probe_results.py \
  --raw-dir phase1/phase1_pet/results/raw/oxford_iiit_pet/frozen_probe_v1/batch128 \
  --report-dir phase1/phase1_pet/reports/frozen_probe/batch128
```
