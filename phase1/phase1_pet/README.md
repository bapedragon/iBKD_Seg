...
```bash
bash phase1/phase1_pet/scripts/run_probe_smoke_b64.sh
bash phase1/phase1_pet/scripts/run_probe_smoke_b128.sh
```
...
```bash
bash phase1/phase1_pet/scripts/run_alg_warmup20_smoke_b128.sh
```
