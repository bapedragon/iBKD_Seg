...
output_dir="${PHASE1_PROBE_OUTPUT_DIR:-/app/output/phase1_pet_probe_b128_full_v1}"
cache_dir="${PHASE1_PROBE_CACHE_DIR:-/app/scratch/phase1_pet_probe_b128_full_v1_cache}"
...
if [[ ! -f "${classification_root}/classification_summary.json" ]]; then
  ...
  python -m ibkd_seg.phase1.release_asset \
    --manifest phase1/phase1_pet/reports/classification/batch128/checkpoint_release.json \
