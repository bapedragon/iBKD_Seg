...
- 정성 결과 확인과 보고서 생성
- Phase 1 feature caching과 소규모 frozen-probe 실험
...
로컬에서 충분히 수행할 수 있고 feature를 cache한 Phase 1 pilot도 현실적이라는
...
- 신뢰 가능한 pixel GT 데이터셋에서 Vanilla/ALG/iBKD 분류 encoder 재학습
