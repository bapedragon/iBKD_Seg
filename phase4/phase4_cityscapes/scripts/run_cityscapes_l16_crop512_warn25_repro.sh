...
output_root="${CITYSCAPES_CROP512_WARN25_OUTPUT:-/app/output/cityscapes_l16_crop512_warn25_repro_v9}"
config="${PWD}/phase4/phase4_cityscapes/configs/paper_l16_crop512_warn25_repro_v9.json"
...
run_suite() {
  ...
  echo "[CROP512_L16_WARN25_REPRO] stage=verify_zip"
  ...
  echo "[CROP512_L16_WARN25_REPRO] stage=prepare_train_val"
  ...
  echo "[CROP512_L16_WARN25_REPRO] stage=official_sources_and_pretrained_weights"
  python -m ibkd_seg.cityscapes.official_assets --cache-root "${cache_root}"
  echo "[CROP512_L16_WARN25_REPRO] stage=lg_a_lg_b_alg_ibkd_a_ibkd_b"
  python -u -m ibkd_seg.cityscapes.warn_only_reproducibility \
