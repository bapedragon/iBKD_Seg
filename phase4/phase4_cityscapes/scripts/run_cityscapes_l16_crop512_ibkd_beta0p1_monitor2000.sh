...
output_root="${CITYSCAPES_IBKD_BETA0P1_MONITOR_OUTPUT:-/app/output/cityscapes_l16_crop512_ibkd_beta0p1_monitor2000_v14}"
config="${PWD}/phase4/phase4_cityscapes/configs/paper_l16_crop512_ibkd_beta0p1_monitor2000_v14.json"
...
run_suite() {
  ...
  echo "[CROP512_L16_IBKD_BETA0P1_MONITOR2000] stage=verify_zip"
  ...
  echo "[CROP512_L16_IBKD_BETA0P1_MONITOR2000] stage=prepare_train_val"
  ...
  echo "[CROP512_L16_IBKD_BETA0P1_MONITOR2000] stage=official_sources_and_pretrained_weights"
  python -m ibkd_seg.cityscapes.official_assets --cache-root "${cache_root}"
  echo "[CROP512_L16_IBKD_BETA0P1_MONITOR2000] stage=single_monitor_only_run"
