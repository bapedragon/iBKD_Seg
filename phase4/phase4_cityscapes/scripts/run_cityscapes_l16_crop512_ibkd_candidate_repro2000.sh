...
output_root="${CITYSCAPES_IBKD_REPRO2000_OUTPUT:-/app/output/cityscapes_l16_crop512_ibkd_candidate_repro2000_v12}"
config="${PWD}/phase4/phase4_cityscapes/configs/paper_l16_crop512_ibkd_candidate_repro2000_v12.json"
...
run_suite() {
  ...
  echo "[CROP512_L16_IBKD_CANDIDATE_REPRO2000] stage=verify_zip"
  ...
  echo "[CROP512_L16_IBKD_CANDIDATE_REPRO2000] stage=prepare_train_val"
  ...
  echo "[CROP512_L16_IBKD_CANDIDATE_REPRO2000] stage=official_sources_and_pretrained_weights"
  python -m ibkd_seg.cityscapes.official_assets --cache-root "${cache_root}"
  echo "[CROP512_L16_IBKD_CANDIDATE_REPRO2000] stage=ibkd_beta_0p5_a_b"
  python -u -m ibkd_seg.cityscapes.ibkd_candidate_reproducibility \
