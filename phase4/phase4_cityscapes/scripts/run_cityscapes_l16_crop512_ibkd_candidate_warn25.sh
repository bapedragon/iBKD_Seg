...
output_root="${CITYSCAPES_IBKD_CANDIDATE_WARN25_OUTPUT:-/app/output/cityscapes_l16_crop512_ibkd_candidate_warn25_v11}"
config="${PWD}/phase4/phase4_cityscapes/configs/paper_l16_crop512_ibkd_candidate_warn25_v11.json"
...
run_suite() {
  ...
  echo "[CROP512_L16_IBKD_CANDIDATE_WARN25] stage=verify_zip"
  ...
  echo "[CROP512_L16_IBKD_CANDIDATE_WARN25] stage=prepare_train_val"
  ...
  echo "[CROP512_L16_IBKD_CANDIDATE_WARN25] stage=official_sources_and_pretrained_weights"
  python -m ibkd_seg.cityscapes.official_assets --cache-root "${cache_root}"
  echo "[CROP512_L16_IBKD_CANDIDATE_WARN25] stage=ibkd_candidate_a_b"
