...
output_root="${CITYSCAPES_IBKD_LAMBDA0P5_SMOKE_OUTPUT:-/app/output/cityscapes_l16_crop512_ibkd_lambda0p5_beta_grid_smoke25_v16}"
config="${PWD}/phase4/phase4_cityscapes/configs/paper_l16_crop512_ibkd_lambda0p5_beta_grid_smoke25_v16.json"
...
run_suite() {
  ...
  echo "[CROP512_L16_IBKD_LAMBDA0P5_SMOKE25] stage=verify_zip"
  ...
  echo "[CROP512_L16_IBKD_LAMBDA0P5_SMOKE25] stage=prepare_train_val"
  ...
  echo "[CROP512_L16_IBKD_LAMBDA0P5_SMOKE25] stage=official_sources_and_pretrained_weights"
  python -m ibkd_seg.cityscapes.official_assets --cache-root "${cache_root}"
  echo "[CROP512_L16_IBKD_LAMBDA0P5_SMOKE25] stage=four_beta_runs_25_steps"
