...
output_root="${CITYSCAPES_TI16_OUTPUT:-/app/output/cityscapes_ti16_ibkd_l025_grid2000_v1/run_$(date -u +%Y%m%dT%H%M%SZ)_$$}"
config="${repo_root}/phase4/Cityscapes_Segmenter-Ti16/configs/beta_grid2000_ibkd_l025_v1.json"
...
run_suite() {
  ...
  echo "[TI16_GRID2000] pack=ibkd_l025 candidates=8 steps_each=2000 seed=1 full_val=500 budget_seconds=35100 output=${output_root}"
