...
현재 다음 단계는 [β4개·2k 이슈](H200_WARMUP20_CHECK2000_ISSUE.md)입니다.
...
별도로 마련했습니다. H200 32-step smoke는 완료했고 2k·10k는 아직 시작하지 않았습니다.
...
검사 결과와 성공 범위를 구분하며 2k·10k 결과는 실행 후 추가합니다.
