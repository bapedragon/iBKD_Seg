...
**2026-09-25 현재 상태:** λ=0.25 β4개 smoke와 [네 후보의 2k 재실험](reports/h200_warmup20_check2000_lambda025/RESULTS.md)을
완료했습니다. 전체 val500·재개 검사·2k 끝까지 guidance 유지를 확인했으며 최고 mIoU는 45.3352%입니다.
Warm-up 20의 성능 개선이나 최종 β를 확정하지 않고 네 후보를 유지합니다.
...
별도로 마련했습니다. λ=0.25의 smoke·2k는 완료했으며 10k 및 λ=0.5 warm-up 20은 아직 미실행입니다.
...
기존 warm-up 0 H200 검증과 새 warm-up 20의 32-step H200 smoke를 완료했습니다.
새 smoke에서 GPU 속도·연결을 확인했지만 3720/3721 경계와 장기 성능 검증은 아닙니다.
H200 실행에는 입력 32-batch 사전 검사와 step2→3 전체 상태 재개·재실행 검사가 포함됩니다.
λ=0.25의 2k 결과는 위 보고서에 추가했습니다. 10k·보호 종료 경계 이후 결과는 실행 후 추가합니다.
