...
**β=0.197479·0.460784**, iBKD λ=0.25는 **β=0.903048·3.87021**을 10k에 유지합니다.
[pack3 결과](reports/h200_screen2000_v2_pack3/RESULTS.md)도 4/4 완료했습니다.
iBKD λ=0.5는 최고 mIoU 45.6926%이며 **β=0.4303·1.00403**을 10k에 유지합니다.
네 β 조건의 상위 2개와 고정 baseline 2개, 총 **10개 실행**의 10k 재개가 다음 단계입니다.
...
| iBKD λ=0.25 | 전체 8개 block을 256채널·16×16로 맞춰 가중합, 1 epoch 분량마다 종료 판단, β 선별 | 2k 후보 기록 확인; β=0.903048·3.87021을 10k에 유지 |
| iBKD λ=0.5 | 위와 동일한 연결·controller, 이 λ 조건에서 β 선별 | 2k 완료; β=0.4303·1.00403을 10k에 유지 |
...
LG·ALG·iBKD 두 λ의 10k 후보를 각각 2개 선정했으며, 최종 β는 10k에서 선정합니다.
...
LG·ALG·iBKD 두 λ는 **10k 후보를 각각 2개 선정**했습니다. 다음 작업은
고정 baseline 및 선정 후보의 10k 재개 준비입니다. 완료한 2k 후보 실행을 반복하지 않습니다.
