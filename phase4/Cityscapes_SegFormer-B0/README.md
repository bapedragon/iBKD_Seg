...
Pack2·3 결과는 아직 제출되지 않았고, 10k·80k 결과도 없습니다.
...
LG의 10k 후보 2개를 선정했으며 최종 β 확정과 다른 세 β 조건의 선별은 남아 있습니다.
...
LG는 **10k 후보 2개를 선정**했습니다. 다음 작업은 pack2·3의 결과 확인과
고정 baseline 및 선정 후보의 10k 재개 준비입니다. 완료한 pack1 2k는 반복하지 않습니다.
