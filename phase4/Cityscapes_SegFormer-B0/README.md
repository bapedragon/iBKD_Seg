...
Pack3(iBKD λ=0.5) 결과와 10k·80k 결과는 아직 없습니다.
...
LG·ALG·iBKD λ=0.25의 10k 후보를 각각 2개 선정했으며, 최종 β 확정과 iBKD λ=0.5 선별은 남아 있습니다.
...
LG·ALG·iBKD λ=0.25는 **10k 후보를 각각 2개 선정**했습니다. 다음 작업은 pack3 결과 확인과
