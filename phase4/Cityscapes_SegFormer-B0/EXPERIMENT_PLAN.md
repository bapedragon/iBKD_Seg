...
**2026-09-25:** λ=0.25·warm-up 20의 smoke와 [β4개·2k 재실험](reports/h200_warmup20_check2000_lambda025/RESULTS.md)을
완료했습니다. 네 후보 모두 guidance를 유지했고 최고 mIoU는 β=0.387021의 45.3352%입니다.
점검 당시에는 네 후보를 유지했습니다. 이후 사용자 결정으로 iBKD λ=0.25는 β=0.387021·1.9351,
ALG는 β=0.197479·0.460784의 상위 두 후보를 10k에 유지합니다. 이번에는 각 1위 하나씩
[통합 이슈](H200_TOP1_10K_ISSUE.md)로 실행해 **2/2 완료**했습니다.
[결과](reports/h200_top1_10k_v1/RESULTS.md)는 ALG best 60.1973%, iBKD best 60.0381%입니다.
ALG 보호 0·iBKD 보호 20을 유지했고 iBKD는 step3720에서 종료했습니다.
이번 점검에서 추가 GPU 작업은 시작하지 않았으며 각 2순위 β의 10k 비교가 남았습니다.

**2026-09-24 변경 기록:** iBKD λ=0.25·0.5에만 guidance warm-up 20을 적용하고 ALG는 0으로
유지합니다. [변경 프로토콜](WARMUP20_PROTOCOL.md) 및 [이슈 2개](H200_WARMUP20_ISSUES.md)를
준비했습니다. 기존 2k 결과·고정 명세는 warm-up 0 기록으로 보존합니다.
당시 계획은 λ별 β 4개 모두 10k였습니다. λ=0.25의 후보 범위는 위 9월 25일 결정으로 대체합니다.
...
현재 10k 대상은 Vanilla·FSKD 각 1개, LG·ALG 각 2개, iBKD λ=0.25 두 개와
λ=0.5 네 개로 총 **12개 실행 궤적**입니다. 9월 24일의 14개 계획에서 λ=0.25 두 후보를 줄였습니다.
10k는 위 각 1위 두 후보만 완료했고 나머지 후보 및 80k는 아직 미실행입니다.
...
아래 표는 완료한 **warm-up 0의 최초 선별 계획**을 보존합니다. 최신 λ=0.25는 warm-up 20의
2k 상위 두 β를 10k까지 비교합니다. λ=0.5는 네 후보 계획을 유지합니다. Warm-up 0 iBKD
checkpoint를 warm-up 20 실행에 승계하지 않으며, 동일한 warm-up 20 전체 상태는 재개할 수 있습니다.
이번 실행 범위는 [별도 JSON](configs/b0_top2_10k_v1.json)에 기록했습니다. 변경 없는 방법은 최초 규칙을 유지합니다.
...
작업당 10시간 제한에는 [9시간 40분 예산](JOB_RUNTIME.md)을 적용하고 그 안에 전체 상태를 저장합니다.
...
ALG는 0을 유지합니다. 새 iBKD λ=0.25의 H200 smoke와 2k 재실험은 4/4 완료했고,
ALG·iBKD λ=0.25 각 1위 β의 10k도 2/2 완료했습니다. 각 2순위 β의 10k는 남았습니다.
