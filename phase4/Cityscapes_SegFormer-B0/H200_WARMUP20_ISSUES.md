...
**현재는 아래 10k 이슈를 바로 제출하지 않습니다.** 사용자 후속 결정으로
[λ=0.25 β4개 smoke → 별도 2k](H200_WARMUP20_SMOKE_ISSUE.md)를 먼저 실행합니다.
...
설치·준비를 포함해 9시간 예산 안에 저장 여유를 두고 중단하며 필요하면 여러 작업으로 재개합니다.
