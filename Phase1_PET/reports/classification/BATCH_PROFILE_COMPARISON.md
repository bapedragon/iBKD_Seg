...
```bash
python Phase1_PET/scripts/compare_classification_profiles.py \
  --batch64-summary Phase1_PET/reports/classification/batch64/summary.json \
  --batch128-summary Phase1_PET/reports/classification/batch128/summary.json \
  --output-json Phase1_PET/reports/classification/batch_profile_comparison.json \
  --output-csv Phase1_PET/reports/classification/batch_profile_comparison.csv
```
